/*this fucntion gets the task from input*/
function get_todos() {
    /*This creates an array of tasks that are inputed*/
    var todos = new Array;
    /*This pulls the task that was saved inthe web browser memory*/
...
/*This ill keep the inputs displayed permanetly on the screen*/
show();
/*This creates an event with a the buttons are double clicked*/
function myFunction() {
