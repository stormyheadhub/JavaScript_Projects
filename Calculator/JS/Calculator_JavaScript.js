...
function Input_Digit(digit) {
    ...
    //This checks if the Wiat+Second is true and sets Display_Value
...
function Input_Decimal(dot) {
    //This ensures that accidental clicking of the decimal point doesnn't
...
keys.addEventListener('click', (event) => {
    ...
    //that was clicked.
    const { target } = event;
    //If the element that was clicked on is not a butotn, exit the function.
